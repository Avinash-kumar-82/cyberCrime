    ...
    useEffect(() => {
        const fetchFIRs = async () => {
            ...
            try {
                ...
                // Filter FIRs assigned to this police wallet
                const myFIRs = allFIRs.filter(f => f.assignedPolice.toLowerCase() === web3.selectedAccount.toLowerCase());
    ...
    return (
        <div className="p-6">
            ...
            <div className="flex gap-4 mb-4">
                {["ALL", "FIR_SUBMITTED", "FIR_VERIFIED", "FIR_REJECTED", "CASE_UNDERPROCESS", "CASE_CLOSED"].map(
                    f => (
                        <button
                            key={f}
                ...
                {filteredFIRs.map(fir => (
                    ...
                    >
                        <div>
                            ...
                            <p><strong>Assigned Police:</strong> {fir.assignedPolice.slice(0, 6) + "..." + fir.assignedPolice.slice(-4)}</p>
                        </div>
                    </div>
                ))}
            </div>
